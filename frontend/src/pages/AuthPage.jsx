...
function RegisterPage() {
  ...
  return (
    <div className='flex items-center justify-center w-full'>
      ...
      <form onSubmit={form} className='p-5 rounded-md flex items-center justify-between flex-col gap-5 w-[320px]'>
        ...
        <div className='flex items-start justify-start gap-2 flex-col w-full'>
          ...
          <div className='flex flex-col gap-1 w-full'>
            ...
            <div className='relative w-full'>
              <span className='absolute top-0 left-0 -translate-y-1/2'>
                <UserRound />
              </span>
              <input disabled={loading} value={username} onChange={(e) => setUsername(e.target.value)} className='border-2 px-2 py-2 rounded-md border-Input-Border focus:border-Input-Focus outline-0 w-full' type="text" id='name' placeholder='Your Name' name='username' />
            </div>
          </div>
  ...
  return (
    <div className='flex items-center justify-center flex-col w-full min-h-[400px]'>
      ...
      >
        ...
        <button className='bg-Primary text-white w-full text-center rounded-md p-2 cursor-pointer flex items-center justify-center gap-1' type='submit' disabled={loading}>
